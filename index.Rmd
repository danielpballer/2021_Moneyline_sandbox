...
indiv_winners = indiv_disp_2 %>% filter(Percent == max(Percent)) %>% select(Name) %>% pull()
indiv_season = indiv_disp_2 %>% filter(`Season Percent` == max(`Season Percent`)) %>% select(Name) %>% pull()
indiv_season_adj = indiv_disp_2 %>% filter(`Adj Season Percent` == max(`Adj Season Percent`)) %>% select(Name) %>% pull()
```
...
c_indiv_winners = c_indiv_disp_2 %>% filter(Percent == max(Percent)) %>% select(Name) %>% pull()
c_indiv_season = c_indiv_disp_2 %>% filter(`Season Percent` == max(`Season Percent`)) %>% select(Name) %>% pull()
c_indiv_season_adj = c_indiv_disp_2 %>% filter(`Adj Season Percent` == max(`Adj Season Percent`)) %>% select(Name) %>% pull()
```
...
```{r}
valueBox(value = indiv_winners,icon = "fa-user-plus",caption = "Best Picks of the Week",color = "green")
```

### Best picks of the season
```{r}
valueBox(value = indiv_season,icon = "fa-user-plus",caption = "Season Leader",color = "green")
```

### Best picks of the season adjusted
```{r}
valueBox(value = indiv_season_adj,icon = "fa-user-plus",caption = "Adjusted Season Leader",color = "green")
```
...
### Best picks of the week
```{r}
valueBox(value = c_indiv_winners,icon = "fa-user-plus",caption = "Best Picks of the Week",color = "green")
```

### Best picks of the season
```{r}
valueBox(value = c_indiv_season,icon = "fa-user-plus",caption = "Season Leader",color = "green")
```

### Best picks of the season adjusted
```{r}
valueBox(value = c_indiv_season_adj,icon = "fa-user-plus",caption = "Adjusted Season Leader",color = "green")
```
