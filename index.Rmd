...
cbs = read_csv("./CSV_Data_Files/CBS_Experts_3.csv")
espn = read_csv("./CSV_Data_Files/ESPN_Experts_3.csv")
...
```{r instructor beating cbs, include=FALSE}
...
```{r instructor beating ESPN, include=FALSE}
#Creating a list of correct percentages for each week.
...
```{r Cadet beating cbs, include=FALSE}
