...
#Scraping CBS Expert Predictions
```{r}
...
#Scraping ESPN Expert Predictions
```{r}
...
########################## Sandbox
```{r}
read_html("https://www.cbssports.com/nfl/picks/experts/straight-up/1/")%>%
    html_nodes(".TableExpertPicks-weekRecords")%>%
    html_text() %>% 
    matrix(ncol = 1, byrow = TRUE) %>%
    as.data.frame()%>%
